namespace Sofomo.Weather.Infrastructure.WeatherForecastApi.Configuration;

public class WeatherForecastHttpConfiguration
{
    public const string Daily = "daily";
    public const string ForecastDays = "forecast_days";
